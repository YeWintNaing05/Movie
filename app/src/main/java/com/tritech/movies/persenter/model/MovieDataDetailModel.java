package com.tritech.movies.persenter.model;

import com.tritech.movies.data.net.model.BelongsToCollection;
import com.tritech.movies.data.net.model.Genre;
import com.tritech.movies.data.net.model.ProductionCompany;
import com.tritech.movies.data.net.model.ProductionCountry;
import com.tritech.movies.data.net.model.SpokenLanguage;

import java.util.List;

public class MovieDataDetailModel {
